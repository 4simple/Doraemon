...
function _addMethod(name, func) {
    MODS[name] = function() {
        return bMock ? mock(name) : func.apply(null, arguments);
    }
}
    ...
    for (var key in obj) {
        ...
        if (typeof obj[key] === "function") {
            receiver[name][key] = (function(func) {
                return function() {
                    bMock ? mock(name + "." + key) : func.apply(obj, arguments);
                }
            })(obj[key])
        }
            ...
            receiver[name][key] = bMock ? mock(name + "." + key) : obj[key];
        }
    }
}

module.exports = exports = function(bMock) {
    bMock = !!bMock
    return {
        add: function(name, definition) {
            ...
            if (typeof definition === "function") {
                ...
                MODS[name] = bMock ? mock(name) : definition;
            }
